...
public final class Constants {
  ...
  public static final class DriveConstants {
    ...
    // =========================================================================
    // TODO (Tutorial 5 — Tune Your Drive)
    //
    // Add a constant for the drive speed scale (the 0.75 in Drivetrain.java).
    // Then replace the magic number in Drivetrain.java with this constant.
    //
